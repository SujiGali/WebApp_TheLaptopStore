...
public class PaymentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       // processRequest(request, response);
        ...
        u.setExpirationMonth(expirationMonth);
        u.setExpirationYear(expirationYear);
        u.setSecurityCode(securityCode);
        PaymentDB udb = new PaymentDB();
        
        try {
            udb.addCard(u);
            getServletContext().getRequestDispatcher("/orderReciept.jsp").forward(request, response);
